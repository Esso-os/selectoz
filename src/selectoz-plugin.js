...
function selectoz(opts) {
    ...
    var optIconFocus = opts.icon.focus.split(' ')[1]
    var optIconBlur = opts.icon.blur.split(' ')[1];
            ...
            if (target.classList.contains('select-input')) {
                if (!checkOnce) {
                    ...
                    (activeselectOz.classList.contains('active-selectoz')) ?
                        toggleIcon(activeselectOz, optIconBlur, optIconFocus) :
                        toggleIcon(activeselectOz, optIconFocus, optIconBlur);
                } else {
                    checkOnce = 0;
                }
    ...
    each(selectOz, (i, elem) => {
        elem.onfocus = (e) => {
            ...
            toggleIcon(elem, optIconBlur, optIconFocus);
        };
        elem.onblur = (e) => {
            elem.classList.remove('active-selectoz');
            checkOnce = 1;
            toggleIcon(elem, optIconFocus, optIconBlur);
        };
    });
